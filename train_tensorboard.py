...
def train_func(config):
    ...
    # variable_scope(計算グラフ可視化　name_scapeでもいいと思う)
    ...
    # loss,histgram_loss(in AdapNet_pp.py)表示(tensorboard)のため
    ...
    # TensorBoardのloss表示などは2回ckpt来るまで待ってください
    #with tf.Session() as sess: ←なんかいらなかった
    #tf.summary.image('image', images_pl, 10)
